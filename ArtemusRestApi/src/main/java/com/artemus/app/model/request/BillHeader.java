...
public class BillHeader {
	...
	@XmlTransient
	@Hidden
	private String manifestErrorDescription;
	...
	public String getManifestErrorDescription() {
		if(manifestErrorDescription==null){
			return "";
		}
		return manifestErrorDescription;
	}

	public void setManifestErrorDescription(String manifestErrorDescription) {
		this.manifestErrorDescription = manifestErrorDescription;
	}
