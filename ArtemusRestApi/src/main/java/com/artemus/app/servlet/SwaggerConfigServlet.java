...
public class SwaggerConfigServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		 ...
		 * swaggerConfig.setVersion("3.0"); swaggerConfig.setSchemes(new
		 * String[]{"http"}); swaggerConfig.setHost("localhost:8080");
		 ...
		 */
		  ...
		  // this makes Swagger honor JAXB annotations Json.mapper().registerModule(new
		/*
